 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function X(i,t,e){let r="Unexpected state";typeof t=="string"?r=t:e=t,Nd(i,r,e)}function Nd(i,t,e){let r=`FIRESTORE (${jr}) INTERNAL ASSERTION FAILED: ${t} (ID: ${i.toString(16)})`;if(e!==void 0)try{r+=" CONTEXT: "+JSON.stringify(e)}catch{r+=" CONTEXT: "+e}throw Ln(r),new Error(r)}function Et(i,t,e,r){let s="Unexpected state";typeof e=="string"?s=e:r=e,i||Nd(t,s,r)}function ot(i,t){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Od(i,t,e){if(!e)throw new H(U.INVALID_ARGUMENT,`Function ${i}() cannot be called with an empty ${t}.`)}function Eg(i,t,e,r){if(t===!0&&r===!0)throw new H(U.INVALID_ARGUMENT,`${i} and ${e} cannot be used together.`)}function Hu(i){if(!K.isDocumentKey(i))throw new H(U.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${i} has ${i.length}.`)}function $u(i){if(K.isDocumentKey(i))throw new H(U.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${i} has ${i.length}.`)}function Vd(i){return typeof i=="object"&&i!==null&&(Object.getPrototypeOf(i)===Object.prototype||Object.getPrototypeOf(i)===null)}function Na(i){if(i===void 0)return"undefined";if(i===null)return"null";if(typeof i=="string")return i.length>20&&(i=`${i.substring(0,20)}...`),JSON.stringify(i);if(typeof i=="number"||typeof i=="boolean")return""+i;if(typeof i=="object"){if(i instanceof Array)return"an array";{const t=function(r){return r.constructor?r.constructor.name:null}(i);return t?`a custom ${t} object`:"an object"}}return typeof i=="function"?"a function":X(12329,{type:typeof i})}function Ie(i,t){if("_delegate"in i&&(i=i._delegate),!(i instanceof t)){if(t.name===i.constructor.name)throw new H(U.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const e=Na(i);throw new H(U.INVALID_ARGUMENT,`Expected type '${t.name}', but it was: ${e}`)}}return i}/**
 * @license
 * Copyright 2025 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zt(i,t){const e={typeString:i};return t&&(e.value=t),e}function Ys(i,t){if(!Vd(i))throw new H(U.INVALID_ARGUMENT,"JSON must be an object");let e;for(const r in t)if(t[r]){const s=t[r].typeString,a="value"in t[r]?{value:t[r].value}:void 0;if(!(r in i)){e=`JSON missing required field: '${r}'`;break}const u=i[r];if(s&&typeof u!==s){e=`JSON field '${r}' must be a ${s}.`;break}if(a!==void 0&&u!==a.value){e=`Expected '${r}' field to equal '${a.value}'`;break}}if(e)throw new H(U.INVALID_ARGUMENT,e);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hr(i){if(i.code!==U.FAILED_PRECONDITION||i.message!==Pg)throw i;$("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const re="WebChannelConnection",As=(i,t,e)=>{i.listen(t,r=>{try{e(r)}catch(s){setTimeout(()=>{throw s},0)}})};class Rr extends gv{constructor(t){super(t),this.a_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}static u_(){if(!Rr.c_){const t=xd();As(t,Ld.STAT_EVENT,e=>{e.stat===Oc.PROXY?$(re,"STAT_EVENT: detected buffering proxy"):e.stat===Oc.NOPROXY&&$(re,"STAT_EVENT: detected no buffering proxy")}),Rr.c_=!0}}zo(t,e,r,s,a){const u=Kc();return new Promise((f,m)=>{const _=new Rd;_.setWithCredentials(!0),_.listenOnce(kd.COMPLETE,()=>{try{switch(_.getLastErrorCode()){case ea.NO_ERROR:const w=_.getResponseJson();$(re,`XHR for RPC '${t}' ${u} received:`,JSON.stringify(w)),f(w);break;case ea.TIMEOUT:$(re,`RPC '${t}' ${u} timed out`),m(new H(U.DEADLINE_EXCEEDED,"Request time out"));break;case ea.HTTP_ERROR:const E=_.getStatus();if($(re,`RPC '${t}' ${u} failed with status:`,E,"response text:",_.getResponseText()),E>0){let R=_.getResponseJson();Array.isArray(R)&&(R=R[0]);const V=R==null?void 0:R.error;if(V&&V.status&&V.message){const F=function(et){const ut=et.toLowerCase().replace(/_/g,"-");return Object.values(U).indexOf(ut)>=0?ut:U.UNKNOWN}(V.status);m(new H(F,V.message))}else m(new H(U.UNKNOWN,"Server responded with status "+_.getStatus()))}else m(new H(U.UNAVAILABLE,"Connection failed."));break;default:X(9055,{l_:t,streamId:u,h_:_.getLastErrorCode(),P_:_.getLastError()})}}finally{$(re,`RPC '${t}' ${u} completed.`)}});const y=JSON.stringify(s);$(re,`RPC '${t}' ${u} sending request:`,s),_.send(e,"POST",y,r,15)})}T_(t,e,r){const s=Kc(),a=[this.qo,"/","google.firestore.v1.Firestore","/",t,"/channel"],u=this.createWebChannelTransport(),f={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},m=this.longPollingOptions.timeoutSeconds;m!==void 0&&(f.longPollingTimeout=Math.round(1e3*m)),this.useFetchStreams&&(f.useFetchStreams=!0),this.Go(f.initMessageHeaders,e,r),f.encodeInitMessageHeaders=!0;const _=a.join("");$(re,`Creating RPC '${t}' stream ${s}: ${_}`,f);const y=u.createWebChannel(_,f);this.I_(y);let w=!1,E=!1;const R=new yv({Jo:V=>{E?$(re,`Not sending because RPC '${t}' stream ${s} is closed:`,V):(w||($(re,`Opening RPC '${t}' stream ${s} transport.`),y.open(),w=!0),$(re,`RPC '${t}' stream ${s} sending:`,V),y.send(V))},Ho:()=>y.close()});return As(y,Rs.EventType.OPEN,()=>{E||($(re,`RPC '${t}' stream ${s} transport opened.`),R.i_())}),As(y,Rs.EventType.CLOSE,()=>{E||(E=!0,$(re,`RPC '${t}' stream ${s} transport closed`),R.o_(),this.E_(y))}),As(y,Rs.EventType.ERROR,V=>{E||(E=!0,qi(re,`RPC '${t}' stream ${s} transport errored. Name:`,V.name,"Message:",V.message),R.o_(new H(U.UNAVAILABLE,"The operation could not be completed")))}),As(y,Rs.EventType.MESSAGE,V=>{var F;if(!E){const q=V.data[0];Et(!!q,16349);const et=q,ut=(et==null?void 0:et.error)||((F=et[0])==null?void 0:F.error);if(ut){$(re,`RPC '${t}' stream ${s} received error:`,ut);const Q=ut.status;let vt=function(C){const I=Ut[C];if(I!==void 0)return pf(I)}(Q),bt=ut.message;Q==="NOT_FOUND"&&bt.includes("database")&&bt.includes("does not exist")&&bt.includes(this.databaseId.database)&&qi(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),vt===void 0&&(vt=U.INTERNAL,bt="Unknown error status: "+Q+" with message "+ut.message),E=!0,R.o_(new H(vt,bt)),y.close()}else $(re,`RPC '${t}' stream ${s} received:`,q),R.__(q)}}),Rr.u_(),setTimeout(()=>{R.s_()},0),R}terminate(){this.a_.forEach(t=>t.close()),this.a_=[]}I_(t){this.a_.push(t)}E_(t){this.a_=this.a_.filter(e=>e===t)}Go(t,e,r){super.Go(t,e,r),this.databaseInfo.apiKey&&(t["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return Dd()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const an="RemoteStore";class Pv{constructor(t,e,r,s,a){this.localStore=t,this.datastore=e,this.asyncQueue=r,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Map,this.Ra=new Map,this.Aa=new ai(1e3),this.Va=new ai(1001),this.da=new Set,this.ma=[],this.fa=a,this.fa.Mo(u=>{r.enqueueAndForget(async()=>{Gi(this)&&($(an,"Restarting streams for network reachability change."),await async function(m){const _=ot(m);_.da.add(4),await no(_),_.ga.set("Unknown"),_.da.delete(4),await Ha(_)}(this))})}),this.ga=new Av(r,s)}}async function Ha(i){if(Gi(i))for(const t of i.ma)await t(!0)}async function no(i){for(const t of i.ma)await t(!1)}function Qc(i,t){return i.Ea.get(t)||void 0}function Lf(i,t){const e=ot(i),r=Qc(e,t.targetId);if(r!==void 0&&e.Ia.has(r))return;const s=function(f,m){const _=Qc(f,m);_!==void 0&&f.Ra.delete(_);const y=function(E,R){return R%2!=0?E.Va.next():E.Aa.next()}(f,m);return f.Ea.set(m,y),f.Ra.set(y,m),y}(e,t.targetId);$(an,"remoteStoreListen mapping SDK target ID to remote",t.targetId,s);const a=new In(t.target,s,t.purpose,t.sequenceNumber,t.snapshotVersion,t.lastLimboFreeSnapshotVersion,t.resumeToken);e.Ia.set(s,a),Ll(e)?kl(e):Gr(e).O_()&&Rl(e,a)}function Cl(i,t){const e=ot(i),r=Gr(e),s=Qc(e,t);$(an,"remoteStoreUnlisten removing mapping of SDK target ID to remote",t,s),e.Ia.delete(s),e.Ea.delete(t),e.Ra.delete(s),r.O_()&&xf(e,s),e.Ia.size===0&&(r.O_()?r.L_():Gi(e)&&e.ga.set("Unknown"))}function Rl(i,t){if(i.pa.$e(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(st.min())>0){const e=i.Ra.get(t.targetId);if(e===void 0)return void $(an,"SDK target ID not found for remote ID: "+t.targetId);const r=i.remoteSyncer.getRemoteKeysForTarget(e).size;t=t.withExpectedCount(r)}Gr(i).Z_(t)}function xf(i,t){i.pa.$e(t),Gr(i).X_(t)}function kl(i){i.pa=new vy({getRemoteKeysForTarget:t=>{const e=i.Ra.get(t);return e!==void 0?i.remoteSyncer.getRemoteKeysForTarget(e):dt()},At:t=>i.Ia.get(t)||null,ht:()=>i.datastore.serializer.databaseId}),Gr(i).start(),i.ga.ua()}function Ll(i){return Gi(i)&&!Gr(i).x_()&&i.Ia.size>0}function Gi(i){return ot(i).da.size===0}function Df(i){i.pa=void 0}async function Sv(i){i.ga.set("Online")}async function Cv(i){i.Ia.forEach((t,e)=>{Rl(i,t)})}async function Rv(i,t){Df(i),Ll(i)?(i.ga.ha(t),kl(i)):i.ga.set("Unknown")}async function kv(i,t,e){if(i.ga.set("Online"),t instanceof _f&&t.state===2&&t.cause)try{await async function(s,a){const u=a.cause;for(const f of a.targetIds){if(s.Ia.has(f)){const m=s.Ra.get(f);m!==void 0&&(await s.remoteSyncer.rejectListen(m,u),s.Ea.delete(m),s.Ra.delete(f)),s.Ia.delete(f)}s.pa.removeTarget(f)}}(i,t)}catch(r){$(an,"Failed to remove targets %s: %s ",t.targetIds.join(","),r),await Ea(i,r)}else if(t instanceof sa?i.pa.Xe(t):t instanceof mf?i.pa.st(t):i.pa.tt(t),!e.isEqual(st.min()))try{const r=await Cf(i.localStore);e.compareTo(r)>=0&&await function(a,u){const f=a.pa.Tt(u);f.targetChanges.forEach((_,y)=>{if(_.resumeToken.approximateByteSize()>0){const w=a.Ia.get(y);w&&a.Ia.set(y,w.withResumeToken(_.resumeToken,u))}}),f.targetMismatches.forEach((_,y)=>{const w=a.Ia.get(_);if(!w)return;a.Ia.set(_,w.withResumeToken(ne.EMPTY_BYTE_STRING,w.snapshotVersion)),xf(a,_);const E=new In(w.target,_,y,w.sequenceNumber);Rl(a,E)});const m=function(y,w){const E=new Map;w.targetChanges.forEach((V,F)=>{const q=y.Ra.get(F);q!==void 0&&E.set(q,V)});let R=new xt(ht);return w.targetMismatches.forEach((V,F)=>{const q=y.Ra.get(V);q!==void 0&&(R=R.insert(q,F))}),new to(w.snapshotVersion,E,R,w.documentUpdates,w.resolvedLimboDocuments)}(a,f);return a.remoteSyncer.applyRemoteEvent(m)}(i,e)}catch(r){$(an,"Failed to raise snapshot:",r),await Ea(i,r)}}async function Ea(i,t,e){if(!$r(t))throw t;i.da.add(1),await no(i),i.ga.set("Offline"),e||(e=()=>Cf(i.localStore)),i.asyncQueue.enqueueRetryable(async()=>{$(an,"Retrying IndexedDB access"),await e(),i.da.delete(1),await Ha(i)})}function Nf(i,t){return t().catch(e=>Ea(i,e,t))}async function $a(i){const t=ot(i),e=ci(t);let r=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:fl;for(;Lv(t);)try{const s=await hv(t.localStore,r);if(s===null){t.Ta.length===0&&e.L_();break}r=s.batchId,xv(t,s)}catch(s){await Ea(t,s)}Mf(t)&&Of(t)}function Lv(i){return Gi(i)&&i.Ta.length<10}function xv(i,t){i.Ta.push(t);const e=ci(i);e.O_()&&e.Y_&&e.ea(t.mutations)}function Mf(i){return Gi(i)&&!ci(i).x_()&&i.Ta.length>0}function Of(i){ci(i).start()}async function Dv(i){ci(i).ra()}async function Nv(i){const t=ci(i);for(const e of i.Ta)t.ea(e.mutations)}async function Mv(i,t,e){const r=i.Ta.shift(),s=Tl.from(r,t,e);await Nf(i,()=>i.remoteSyncer.applySuccessfulWrite(s)),await $a(i)}async function Ov(i,t){t&&ci(i).Y_&&await async function(r,s){if(function(u){return _y(u)&&u!==U.ABORTED}(s.code)){const a=r.Ta.shift();ci(r).B_(),await Nf(r,()=>r.remoteSyncer.rejectFailedWrite(a.batchId,s)),await $a(r)}}(i,t),Mf(i)&&Of(i)}async function Ih(i,t){const e=ot(i);e.asyncQueue.verifyOperationInProgress(),$(an,"RemoteStore received new credentials");const r=Gi(e);e.da.add(3),await no(e),r&&e.ga.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.da.delete(3),await Ha(e)}async function Vv(i,t){const e=ot(i);t?(e.da.delete(2),await Ha(e)):t||(e.da.add(2),await no(e),e.ga.set("Unknown"))}function Gr(i){return i.ya||(i.ya=function(e,r,s){const a=ot(e);return a.sa(),new wv(r,a.connection,a.authCredentials,a.appCheckCredentials,a.serializer,s)}(i.datastore,i.asyncQueue,{Zo:Sv.bind(null,i),Yo:Cv.bind(null,i),t_:Rv.bind(null,i),H_:kv.bind(null,i)}),i.ma.push(async t=>{t?(i.ya.B_(),Ll(i)?kl(i):i.ga.set("Unknown")):(await i.ya.stop(),Df(i))})),i.ya}function ci(i){return i.wa||(i.wa=function(e,r,s){const a=ot(e);return a.sa(),new Tv(r,a.connection,a.authCredentials,a.appCheckCredentials,a.serializer,s)}(i.datastore,i.asyncQueue,{Zo:()=>Promise.resolve(),Yo:Dv.bind(null,i),t_:Ov.bind(null,i),ta:Nv.bind(null,i),na:Mv.bind(null,i)}),i.ma.push(async t=>{t?(i.wa.B_(),await $a(i)):(await i.wa.stop(),i.Ta.length>0&&($(an,`Stopping write stream with ${i.Ta.length} pending writes`),i.Ta=[]))})),i.wa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ne{constructor(t){this._byteString=t}static fromBase64String(t){try{return new Ne(ne.fromBase64String(t))}catch(e){throw new H(U.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(t){return new Ne(ne.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}toJSON(){return{type:Ne._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(t){if(Ys(t,Ne._jsonSchema))return Ne.fromBase64String(t.bytes)}}Ne._jsonSchemaVersion="firestore/bytes/1.0",Ne._jsonSchema={type:zt("string",Ne._jsonSchemaVersion),bytes:zt("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zl{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new H(U.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ee(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rn{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new H(U.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new H(U.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}_compareTo(t){return ht(this._lat,t._lat)||ht(this._long,t._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:rn._jsonSchemaVersion}}static fromJSON(t){if(Ys(t,rn._jsonSchema))return new rn(t.latitude,t.longitude)}}rn._jsonSchemaVersion="firestore/geoPoint/1.0",rn._jsonSchema={type:zt("string",rn._jsonSchemaVersion),latitude:zt("number"),longitude:zt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
